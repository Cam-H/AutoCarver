...
public:
    ...
    static bool writeVectorDVec2(std::ofstream& file, const std::vector<glm::dvec2>& values);
    static bool writeVectorDVec3(std::ofstream& file, const std::vector<glm::dvec3>& values);
    static bool writeTransform(std::ofstream& file, const glm::dmat4x4& value);
    ...
    static std::vector<glm::dvec2> readVectorDVec2(std::ifstream& file);
